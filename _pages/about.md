...
- **🚗 Automobiles** — I am also interested in automobiles, with a slight personal preference for internal combustion engine vehicles over new energy vehicles.
- **🚆 Railways** — I am also a railway enthusiast and enjoy learning about trains and railway systems.
...
Education
======
<table style="width:100%; border-collapse:separate; border-spacing:0; overflow:hidden; border-radius:16px; font-family:Arial, sans-serif; box-shadow:0 8px 24px rgba(0,0,0,0.08); table-layout:fixed;">
  <thead>
    <tr style="background:linear-gradient(90deg, #7cc6ff, #b8f2e6); color:#1f2937;">
      <th style="padding:14px 18px; text-align:left; width:170px; white-space:nowrap;">Time</th>
      <th style="padding:14px 18px; text-align:left; width:320px;">Institution</th>
      <th style="padding:14px 18px; text-align:left;">Stage & Experience</th>
    </tr>
  </thead>
  <tbody>
    <tr style="background:#ffffff;">
      <td style="padding:14px 18px; border-top:1px solid #eef2f7; white-space:nowrap;">2019 – 2023</td>
    ...
    <tr style="background:#f9fcff;">
      <td style="padding:14px 18px; border-top:1px solid #eef2f7; white-space:nowrap;">2023 – Present</td>
    ...
    <tr style="background:#ffffff;">
      <td style="padding:14px 18px; border-top:1px solid #eef2f7; white-space:nowrap;">Applying</td>
      <td style="padding:14px 18px; border-top:1px solid #eef2f7;">Applying</td>
      <td style="padding:14px 18px; border-top:1px solid #eef2f7;">
